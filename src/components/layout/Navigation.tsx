    ...
    <nav className="w-full bg-white border-b border-black rounded-none">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          <Link href="/login" className="border border-black px-4 py-2 text-xs uppercase font-bold text-black hover:bg-black hover:text-white transition-colors rounded-none">
            로그인
          </Link>
